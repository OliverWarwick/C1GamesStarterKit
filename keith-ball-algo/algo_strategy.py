...
class AlgoStrategy(gamelib.AlgoCore):
                ...
                for unit in game_state.game_map[loc]:
                    ...
                    if target_unit is not None:
                        ...
                        if(target_unit.stationary):
                            ...
                            gamelib.debug_write("Unit at location ({}, {}) firing at target ({}, {}) doing damage {}".format(loc[0], loc[1], target_unit.x, target_unit.y, unit.damage_d))
    ...
    def add_health_from_supports(self, game_map):
        # TODO
        pass
